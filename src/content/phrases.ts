export const catchPhrase = `Your go-to UI designer with a strong coding background.`

export const catchDetail = `With over 15\u00A0years of experience in UI design and front-end development, I\u00A0bring value through my ability to seamlessly connect design and implementation.`
